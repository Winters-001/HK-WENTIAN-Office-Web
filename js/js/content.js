...
const DEFAULT_CONTENT = {
  ...
  advantages: {
    ...
    items: [
      { icon: "shield", title: "品質保障", desc: "嚴格的品質管控體系。東莞石碣檢測中心通過CNAS國家實驗室認證（CNAS L5219）及CMA檢驗檢測資質認定，從源頭種植到冷鏈配送全程可追溯，確保每一份食材符合最高安全標準。只售一級菜，口感係唔同！" },
      { icon: "truck", title: "穩定供應", desc: "與源頭種植基地建立長期合作，全年無間斷供應各類食材。內地加工基地位於廣東東莞，具備完善的現場加工與品控把關能力，確保香港餐廳運營永不缺貨。" },
      { icon: "search", title: "安全可追溯", desc: "持有CAAC民用無人駕駛航空器運營合格證，擁有農業無人機等專利技術及九項軟件著作權。同時，食物進口嚴格遵循香港食安中心法規，源自福島等10都縣的食品禁止進口，確保食品安全。" },
      { icon: "layers", title: "一站式服務", desc: "蔬菜、淨菜加工、米麵糧油、肉類水產，全品類覆蓋。從採購、加工到配送，提供完整的食材解決方案。同時布局AI無人機末端配送技術研發，打造未來物流生態。" }
    ]
  },
  products: {
    label: "OUR PRODUCTS",
    ...
    items: [
      { title: "和光一級鮮菜", desc: "「和光蔬菜」品牌一級新鮮蔬菜，色澤鮮亮、含氧量足、新鮮飽滿。專爲追求新鮮、安全與品質的餐廳而選。只售一級菜，口感係唔同！", image: "" },
      { title: "專業淨菜加工", desc: "專業淨菜加工服務，清洗、切割、包裝一體化。東莞加工基地具備完善的現場加工與品控把關能力，爲香港餐廳節省後廚時間，提升出餐效率。", image: "" },
      { title: "米麵糧油供應", desc: "精選優質大米、麵粉及食用油，滿足中西方餐飲的不同需求。穩定供應鏈確保全年無間斷配送，讓餐廳運營無後顧之憂。", image: "" },
      { title: "肉類水產海鮮", desc: "優質肉類、禽類及水產海鮮，冷鏈直送鎖住新鮮與營養。嚴格遵循香港食安中心進口法規，確保每一批次產品安全可靠。", image: "" }
    ]
  },
  cases: {
    label: "CLIENT CASES",
  ...
  news: {
    ...
    title: "新闻动态",
    items: [
      { date: "2026.06.28", title: "豈朝科技亮相第四屆全球數字貿易博覽會", summary: "黑龍江攜34家數字企業亮相數貿會，豈朝科技在「數貿龍江」板塊展示AI數字服務與數商融合成果，獲省政府重點推介。", image: "" },
      { date: "2026.06.15", title: "「和光蔬菜」品質檢測中心通過CNAS複評審", summary: "東莞市東正農產品檢測有限公司再次通過CNAS國家實驗室認可（CNAS L5219），有效期至2030年，持續爲食材安全保駕護航。", image: "" },
      { date: "2026.05.30", title: "香港問天實業獲食物進口商登記資質", summary: "公司正式取得香港食物進口商/分銷商登記（TR-25-001129），具備日本食品進口資質，跨境生鮮業務全面啓動。", image: "" }
    ]
  },
  contact: {
    label: "GET IN TOUCH",
    ...
    items: [
      { icon: "phone", label: "联系电话", value: "+852 2156 3017" },
      { icon: "mail", label: "电子邮箱", value: "info@wentian.com.hk" },
      { icon: "map", label: "办公地址", value: "香港粉嶺軍地龍馬路66號" }
    ]
  },
  footer: {
    brand: "問天實業",
